...
Player::Player()
{
	...
	/*mAnimationJumping = new Animation("Resources/megaman/jumpingright.png", 1, 1, 1, 0);*/
	mAnimationRunning = new Animation("Resources/megaman/runningright.png", 11, 1, 11, 0.05f);
