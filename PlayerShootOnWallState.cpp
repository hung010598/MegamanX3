...
PlayerShootOnWallState::PlayerShootOnWallState(PlayerData *playerData)
{
...
PlayerShootOnWallState::~PlayerShootOnWallState()
{
}

void PlayerShootOnWallState::Update(float dt)
{
...
void PlayerShootOnWallState::HandleKeyboard(std::map<int, bool> keys)
{
...
void PlayerShootOnWallState::OnCollision(Entity *impactor, Entity::SideCollisions side, Entity::CollisionReturn data)
{
...
PlayerState::StateName PlayerShootOnWallState::GetState()
{
	return PlayerState::ShootOnWall;
}
